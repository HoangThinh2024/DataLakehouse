...
What it checks:
1. **Container States:** Verifies all 15 Docker containers are running.
...
6. **HTTP Ports:** Validates all web consoles and APIs (Mage, Superset, Grafana, Redpanda Console, CloudBeaver).
