...
REDIS_IMAGE_VERSION=$(ask_input "Redis image tag" "${REDIS_IMAGE_VERSION:-8.6.3}")
REDIS_INSIGHT_IMAGE_VERSION=$(ask_input "Redis Insight image tag" "${REDIS_INSIGHT_IMAGE_VERSION:-latest}")
...
REDIS_INSIGHT_IMAGE_VERSION=${REDIS_INSIGHT_IMAGE_VERSION}
