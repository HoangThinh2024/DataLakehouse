...
def build_layout(chart_ids: Dict[str, int]) -> Dict[str, Any]:
    return {
        ...
        "ROW-1": {
            "id": "ROW-1",
            "type": "ROW",
            "children": ["CHART-kpi-cleaned", "CHART-kpi-files"],
            "parents": ["ROOT_ID", "GRID_ID"],
            "meta": {"background": "BACKGROUND_TRANSPARENT"},
        },
        "CHART-kpi-cleaned": {
            "id": "CHART-kpi-cleaned",
            "type": "CHART",
            "children": [],
            "parents": ["ROOT_ID", "GRID_ID", "ROW-1"],
            "meta": {"chartId": chart_ids["kpi_cleaned"], "width": 6, "height": 42},
        },
        "CHART-kpi-files": {
            "id": "CHART-kpi-files",
            "type": "CHART",
            "children": [],
            "parents": ["ROOT_ID", "GRID_ID", "ROW-1"],
            "meta": {"chartId": chart_ids["kpi_files"], "width": 6, "height": 42},
        },
        "ROW-2": {
            "id": "ROW-2",
            "type": "ROW",
            "children": ["CHART-quality", "CHART-events"],
            "parents": ["ROOT_ID", "GRID_ID"],
            "meta": {"background": "BACKGROUND_TRANSPARENT"},
        },
        "CHART-quality": {
            ...
            "meta": {"chartId": chart_ids["quality_table"], "width": 6, "height": 62},
        },
        "CHART-events": {
            "id": "CHART-events",
            "type": "CHART",
            "children": [],
            "parents": ["ROOT_ID", "GRID_ID", "ROW-2"],
            "meta": {"chartId": chart_ids["events_table"], "width": 6, "height": 62},
        },
    }
...
def main() -> None:
    ...
    chart_ids = {
        "kpi_cleaned": ensure_chart(
            ...
            slice_name="DLH 100k - CSV Total Cleaned Rows",
            ...
            params={
                ...
                "metric": {
                    ...
                    "aggregate": "SUM",
                    "label": "SUM(cleaned_rows)",
                },
                "adhoc_filters": [],
                "header_font_size": "0.4em",
                "subheader": "Total cleaned rows from uploaded CSV files",
            },
        ),
        "kpi_files": ensure_chart(
            client,
            dashboard_id=dashboard_id,
            dataset_id=ds_quality,
            slice_name="DLH 100k - CSV Files Processed",
            viz_type="big_number_total",
            params={
                "datasource": f"{ds_quality}__table",
                "viz_type": "big_number_total",
                "metric": {
                    "expressionType": "SIMPLE",
                    "column": {"column_name": "source_key"},
                    "aggregate": "COUNT",
                    "label": "COUNT(source_key)",
                },
                "adhoc_filters": [],
                "header_font_size": "0.4em",
                "subheader": "Total CSV objects processed",
            },
        ),
        "quality_table": ensure_chart(
            ...
            dashboard_id=dashboard_id,
            dataset_id=ds_quality,
            slice_name="DLH 100k - CSV Quality Metrics Latest",
            viz_type="table",
            params={
                "datasource": f"{ds_quality}__table",
                "viz_type": "table",
        ...
        "events_table": ensure_chart(
            ...
            slice_name="DLH 100k - CSV Upload Events Latest",
            viz_type="table",
            params={
                "datasource": f"{ds_events}__table",
                "viz_type": "table",
                "all_columns": ["source_key", "status", "error", "event_time"],
                "adhoc_filters": [],
                "order_desc": True,
                "row_limit": 50,
            },
